...
pop2016$age <- paste0('a_', word(pop2016$age,-4))
...
rm(pop2016,pop2016_pct, pop2016_pct_reshape)
...
pop2011$age <- paste0('a_', word(pop2011$age,1))
...
rm(pop2011, pop2011_pct, pop2011_pct_reshape)
...
pop_reshape$a_85sum = pop_reshape$a_85 + pop_reshape$a_90 + pop_reshape$a_95 + pop_reshape$a_100

pop_reshape$a_85 = NULL
pop_reshape$a_90 = NULL
pop_reshape$a_95 = NULL
pop_reshape$a_100 = NULL
colnames(pop_reshape)[ncol(pop_reshape)]  = 'a_85'
